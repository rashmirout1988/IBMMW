...
- (void)viewDidLoad
{
    ...
    if([delegate.selectedPortfolio isEqualToString:@"integration"])
    {
        ...
        [self.item1.navigationButton1 setBackgroundImage:[UIImage imageNamed:@"dp_tabbar.png"] forState:UIControlStateNormal];
        [self.item1.navigationButton1 setTitle:@"Integration" forState:UIControlStateNormal];
        [self.item1.navigationButton2 setBackgroundImage:[UIImage imageNamed:@"dp_tabbar.png"] forState:UIControlStateNormal];
    ...
    else if([delegate.selectedPortfolio isEqualToString:@"smarterProcess"])
    {
        ...
        [self.item1.navigationButton1 setBackgroundImage:[UIImage imageNamed:@"tabbar.png"] forState:UIControlStateNormal];
        [self.item1.navigationButton1 setTitle:@"Smarter Process" forState:UIControlStateNormal];
        [self.item1.navigationButton2 setBackgroundImage:[UIImage imageNamed:@"tabbar.png"] forState:UIControlStateNormal];
