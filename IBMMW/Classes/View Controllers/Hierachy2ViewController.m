...
- (void)viewDidLoad
{
    ...
    switch (self.portfolioName) {
        case Integration:
            ...
            self.itemNavigationView.navigationButton1.titleLabel.text=@"Integration";
         ...
         case SmarterProcess:
            ...
            self.itemNavigationView.navigationButton1.titleLabel.text=@"Smarter Process";
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"gotoHierachy4"])
    {
        ...
        hierachyObject4.selectedProduct=self.selectedItemAtHierachy1;
